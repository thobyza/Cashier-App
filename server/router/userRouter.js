...
router.post("/cashiers", verifyToken, checkRole, userController.registerCashier);
router.post("/login", userController.login);
router.get("/keep-login", verifyToken, userController.keepLogin);
router.patch("/:id", verifyToken, multerUpload().single("profile_picture"), userController.editProfile);
